	...
	public static function list() {
        ...
        $messages['deposit-limit'] = [
            ...
            'link' =>  [
            	...
            	'url'	=> route('user.transactions', ['list_scheduled' => TransactionStatus::PENDING]),
            	'class'	=> ''
            ],
            'help'	=> self::helps('simple-ask')
        ];
        ...
        $messages['account-add-method'] = [
            ...
            'button' => [
            	...
            	'url'	=> route('user.withdraw.account.index'),
            	'class'	=> ''
            ],
            'link' =>  [
            	'text'	=> __('Go to Dashboard'),
        ...
        $messages['invest-no-plan'] = [
            ...
            'notice' => [
                'caption' => __("We regret that right now there is no funded plan available. Please check back later."),
                'note'  => '',
                'class' => ''
            ],
            'button' => [
