...
class ForexAccountController extends GatewayController
{
    ...
    public function forexAccountCreateNow(Request $request)
    {
        ...
        $input = $request->validate(
            [
                'rule_id' => 'required|exists:account_type_phase_rules,id',
                //            'leverage' => 'required',
        ...
        $rule = AccountTypePhaseRule::find($input['rule_id']);
        //        dd($rule);
        ...
        $input['leverage'] = $rule->accountTypePhase->accountType->leverage;
        //        $input['type'] = $type;
