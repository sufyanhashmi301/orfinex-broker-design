 ...
 * @property float $days_to_pass_amount
 ...
 * @package App\Models
 */
class PricingInvestment extends Model
{
    use Filterable;
	protected $table = 'pricing_investments';
