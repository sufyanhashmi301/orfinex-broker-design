...
class PricingInvestormService extends Service
{
    ...
    public function processSubscriptionDetails($input, $ivScheme, $investAmount,$discount,$leverage_amount,$days_to_pass_amount,$profit_split_amount,$payout_amount,$swap_free_amount): array
    {
...
//        dd($input,$ivScheme,$investAmount);
    ...
    public function confirmSubscription($details): PricingInvestment
    {
        return $this->ivProcessor->setDetails($details)->processInvestment();
    }
    public function confirmSubscriptionForMigration($details): PricingInvestment
    {
        return $this->ivProcessor->setDetails($details)->processInvestmentForMigration();
    }

    public function approveSubscription(PricingInvestment $invest, $remarks = null, $note=null)
    {
        return $this->ivProcessor->approveInvestment($invest, $remarks, $note);
    }

    public function approveSubscriptionForMigration(PricingInvestment $invest, $remarks = null, $note=null)
    {
        return $this->ivProcessor->approveInvestmentForMigration($invest, $remarks, $note);
    }

    public function processInvestmentProfit(PricingInvestment $invest)
    {
//        dd($invest,'processInvestmentProfit');
    ...
    public function cancelSubscription(PricingInvestment $invest)
    {
    ...
    public function processCompleteInvestment(PricingInvestment $invest)
    {
