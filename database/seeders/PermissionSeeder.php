...
//       DB::statement('SET FOREIGN_KEY_CHECKS=1;');
        ...
        $permissions = [
            ...
            ['category' => 'Withdraw Management', 'name' => 'withdraw-account-pending'],
            ['category' => 'Withdraw Management', 'name' => 'withdraw-account-approve'],
            ['category' => 'Withdraw Management', 'name' => 'withdraw-account-rejected'],
            ['category' => 'Withdraw Management', 'name' => 'withdraw-account-action'],
            ['category' => 'Withdraw Management', 'name' => 'withdraw-account-export'],
