    ...
    public function run()
    {
        ...
        $successPages = [
            ...
            [
                ...
                'message' => 'Thank you for your payment. Your transaction has been processed successfully and a confirmation has been sent to your email.',
                'quote' => 'Success is the sum of small efforts repeated day in and day out.',
                'quote_author' => 'Robert Collier',
                'image_path' => 'frontend/images/success-page__img.svg',
                'button_text' => 'Go to Dashboard',
                'button_link' => '/user/dashboard',
                'button_type' => 'primary',
