...
@section('content')
    ...
    <div class="innerMenu card p-6 mb-5 mt-3">
        <ul class="nav nav-pills flex items-center flex-wrap list-none pl-0 space-x-4 menu-open w-full">
            <li class="nav-item">
                <a href="{{ route('admin.affiliates.index') }}" class="nav-link block font-medium font-Inter text-sm leading-tight capitalize rounded-md px-4 py-2 focus:outline-none focus:ring-0 dark:bg-slate-900 dark:text-slate-300 {{ request()->get('status') == null ? 'active' : '' }} ">
                    All
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.affiliates.index', ['status' => 'affiliates_exists' ]) }}" class="nav-link block font-medium font-Inter text-sm leading-tight capitalize rounded-md px-4 py-2 focus:outline-none focus:ring-0 dark:bg-slate-900 dark:text-slate-300 {{ request()->get('status') == 'affiliates_exists' ? 'active' : '' }} ">
                    Affiliate Accounts Exists
                </a>
            </li>
        </ul>
    ...
    @include('backend.affiliates.includes.__users')
