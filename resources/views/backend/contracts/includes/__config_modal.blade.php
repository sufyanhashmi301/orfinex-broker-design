    ...
    <div class="modal-dialog top-1/2 !-translate-y-1/2 relative w-auto pointer-events-none">
        <div
            ...
            <div class="modal-body p-6 pt-0">
                <form action="{{ route('admin.contract.config') }}" method="post" class="space-y-5">
                    @csrf
                    <div class="site-input-area relative">
                      <label for="" class="form-label">Contract Expiry (# of days after creation)</label>
                      <input type="number" name="expiry" class="form-control" value="{{ $contract_expiry }}" required="">
                    </div>  
