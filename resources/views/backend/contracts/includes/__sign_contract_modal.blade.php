<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="signContractModal" tabindex="-1" aria-labelledby="signContractModal" aria-hidden="true">
          ...
          <div class="p-6 space-y-4">
            <form action="{{ route('admin.contract.mark_as') }}" method="POST">
                ...
                <div class="text-center">
                    ...
                    <p class="lead my-3">  
                        You are marking the contract as signed without obtaining a signature. Doing so will grant the user account <b>(#<span class="account-login"></span>)</b> access without their consent to the contract. This action is irreversible.
                    </p>
