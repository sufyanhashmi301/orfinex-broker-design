            ...
            <div class="card-body p-6">
                <form action="{{ route('admin.departments.store') }}" method="post" class="space-y-4">
                    ...
                    <div class="input-area">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Department Name" required/>
                    </div>
                    <div class="input-area">
                    ...
                    <div class="input-area">
                        ...
                        <input type="text" name="department_email" value="{{ old('department_email') }}" class="form-control" placeholder="Department Email" required/>
                    </div>
                    <div class="input-area">
                        <div class="flex items-center space-x-7 flex-wrap">
                            ...
                            <div class="form-switch ps-0" style="line-height: 0">
                                ...
                                <label class="relative inline-flex h-6 w-[46px] items-center rounded-full transition-all duration-150 cursor-pointer">
                                    <input type="checkbox" name="hide_from_client" value="1" class="sr-only peer" {{ old('hide_from_client', 1) == 1 ? 'checked' : '' }}>
