<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="deleteVoucher" tabindex="-1" aria-labelledby="deleteVoucherModal" aria-hidden="true">
            ...
            <div class="p-6 py-10">
                <div class="text-center">
                    <div class="space-y-3">
                        ...
                        <h3 class="text-2xl dark:text-white mb-0">
                            {{ __('Are you sure?') }}
                        </h3>
                        <p class="lead dark:text-slate-300">
                            {{ __('You want to Delete ') }}
                            <strong class="title"></strong> {{ __('Voucher?') }}
                        </p>
                    </div>
