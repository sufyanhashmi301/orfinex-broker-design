                    ...
                    <form action="{{ route('admin.deposit.now') }}" method="post">
                        ...
                        <div class="space-y-5">
                            <div class="input-area">
                                <label for="" class="form-label">
                                    <span class="shift-Away inline-flex items-center gap-1"
                                        data-tippy-content="Select the user who is making the deposit">
                                        {{ __('User') }}
                            ...
                            <div class="input-area">
                                <label for="" class="form-label">
                                    <span class="shift-Away inline-flex items-center gap-1"
                                        data-tippy-content="Select the account or wallet from which the deposit will be made">
                                        {{ __('Account / Wallet') }}
                                        <iconify-icon icon="mdi:information-slab-circle-outline"
                                            class="text-[16px]"></iconify-icon>
                                    </span>
                            ...
                            <div class="input-area">
                                <label for="" class="form-label">
                                    <span class="shift-Away inline-flex items-center gap-1"
                                        data-tippy-content="Select the payment method for the deposit">
                                        {{ __('Payment Method') }}
                                        <iconify-icon icon="mdi:information-slab-circle-outline"
                                            class="text-[16px]"></iconify-icon>
                                    </span>
                            ...
                            <div id="voucher-code-input" class="input-area hidden">
                                ...
                                <input type="text" name="manual_data[voucher code]" class="form-control"
                                    id="voucher-code">
                            ...
                            <div class="input-area">
                                <label for="" class="form-label">
                                    <span class="shift-Away inline-flex items-center gap-1"
                                        data-tippy-content="Enter the amount of the deposit">
                                        {{ __('Enter Amount:') }}
                                        <iconify-icon icon="mdi:information-slab-circle-outline"
                                            class="text-[16px]"></iconify-icon>
                                    </span>
                            ...
                            <div class="input-area conversion hidden">
                                <label for="" class="form-label">
                                    <span class="shift-Away inline-flex items-center gap-1"
                                        data-tippy-content="Enter the amount of the deposit in the currency of the payment method">
                                        {{ __('Enter Amount:') }}
                                        <iconify-icon icon="mdi:information-slab-circle-outline"
                                            class="text-[16px]"></iconify-icon>
                                    </span>
                            ...
                            <div class="input-area">
                                <label for="approval_cause" class="form-label">
                                    <span class="shift-Away inline-flex items-center gap-1"
                                        data-tippy-content="Enter the comments for the deposit">
                                        {{ __('Comments') }}
                                        <iconify-icon icon="mdi:information-slab-circle-outline"
                                            class="text-[16px]"></iconify-icon>
                                    </span>
                    ...
                    success: function(data) {
                        ...
                        $.each(data.forexAccounts, function(key, account) {
                            $('select[name="target_id"]').append('<option value="' + account
                                .login + '" data-type="forex">' + account.login + ' - ' +
                                account.account_name + ' (' + account.equity + ' ' + account
                                .currency + ')</option>');
                        });
