                        ...
                        @csrf
                            ...
                            <div class="input-area">
                                ...
                                <select id="" name="implementation" class="form-control w-100" required>
                                    <option value="default" selected>{{ __('Default') }}</option>
                                    <option value="level_system">{{ __('Level System') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="input-area">
                                ...
                                <select id="" name="purpose" class="form-control w-100" required>
                                    <option value="discount_codes" selected>Discount Codes</option>
