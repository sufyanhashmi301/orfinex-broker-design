                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">
                            ...
                            <div class="input-area">
                                ...
                                <input
                                    ...
                                    class="form-control mb-0"
                                    placeholder="2"
                                    value="{{$swapFreeAccount->level_order}}"
                                    required
                                />
                            </div>
                            <div class="lg:col-span-2 input-area">
                                ...
                                <input
                                    ...
                                    value="{{$swapFreeAccount->group_tag}}"
                                    required
                                />
                            </div>
                            <div class="lg:col-span-2 input-area">
                                ...
                                <input
                                    ...
                                    placeholder="Short Description"
                                     value="{{$swapFreeAccount->description}}"
                                    required
                                />
                            </div>
                            <div class="lg:col-span-2 input-area">
                                ...
                                <select name="status" class="form-control w-full">
                                    <option value="1" {{$swapFreeAccount->status==1?'selected':''}}>{{ __('Enable') }}</option>
                                    <option value="0" {{$swapFreeAccount->status==0 ?'selected':''}}>{{ __('Disable') }}</option>
                                </select>
                            </div>
                        </div>
