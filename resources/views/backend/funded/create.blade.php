                            ...
                            <form action="" class="row" method="post" enctype="">
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <select name="process" class="form-select" id="next_stage_process">
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <select name="applicable_by" class="form-select" id="refundable">
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <select name="type" class="form-select" id="main_risk_track">
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <select name="type" class="form-select" id="random_risk_track">
