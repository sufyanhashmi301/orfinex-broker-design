            ...
            <div class="p-6 space-y-4">
                <div class="text-center">
                    ...
                    <div class="action-btns mt-5">
                        <button type="button" id="confirmDeleteButton" class="btn btn-dark inline-flex items-center justify-center">
                            <iconify-icon class="text-xl ltr:mr-2 rtl:ml-2" icon="lucide:check"></iconify-icon>
                            {{ __('Delete') }}
                        </button>
                        <button type="button" class="btn btn-danger inline-flex items-center justify-center mr-2" data-bs-dismiss="modal">
