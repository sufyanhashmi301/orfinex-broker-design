                                    ...
                                    <tr>
                                        <td class="table-td">
                                            <div class="flex items-center">
                                                <img src="{{ getFilteredPath($user->avatar, 'global/materials/user.png') }}" class="w-8 h-8 rounded-full object-cover mr-3" alt="">
                                                <span>{{ safe($user->full_name) }}</span>
                                            </div>
                                        </td>
                                        <td class="table-td lowercase">{{ safe($user->email) }}</td>
