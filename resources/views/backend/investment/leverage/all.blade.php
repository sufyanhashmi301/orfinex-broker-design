                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.user.edit', $update->user->id) }}" class="flex">
                                                <span
                                                    class="w-8 h-8 rounded-full bg-slate-100 text-slate-900 dark:bg-slate-600 dark:text-slate-200 flex items-center justify-center">
                                                    {{ strtoupper(substr($update->user->username ?? 'NA', 0, 1)) }}
                                                </span>
                                                <div class="ml-3">
                                                    <span
                                                        class="text-sm text-slate-900 dark:text-white block capitalize">{{ $update->user->username ?? 'NA' }}</span>
                                                    <span
                                                        class="text-xs text-slate-500 dark:text-slate-300">{{ $update->user->email ?? 'NA' }}</span>
                                                </div>
                                            </a>
                                        </td>
                                        ...
                                        <td>{{ $update->forexAccount->schema->is_cent_account ? $update->forexAccount->currency . ' (Cents)' : $update->forexAccount->currency }}
                                        </td>
                                        <td><strong>{{ $update->forexAccount->balance }}
                                            ...
                                            <td>
                                                <div class="flex space-x-3 rtl:space-x-reverse">
                                                    @if ($update->status == 1)
                                                        ...
                                                        <button type="button" data-id="{{ $update->id }}"
                                                            data-action="reject"
