                ...
                <div class="p-6">
                    <form action="" method="post">
                        ...
                        <label class="form-label" for="">
                            <span class="shift-Away inline-flex items-center gap-1" data-tippy-content="Enter a new password for investor login">
                        ...
                        <div class="action-btns text-right mt-10">
                            <button type="button" class="btn btn-primary inline-flex items-center justify-center mr-2" id="submit-investor-password" disabled>
