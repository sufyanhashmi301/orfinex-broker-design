<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="changeForexSchema" tabindex="-1" aria-labelledby="changeForexSchema" aria-hidden="true">
        ...
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-dark bg-clip-padding rounded-md outline-none text-current">
            <div class="relative bg-white rounded-lg shadow dark:bg-dark">
                <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600">
                    <div>
                        <h3 class="text-xl font-medium dark:text-white capitalize" id="modalTitle">
                            {{ __('Change Account Schema') }}
                        </h3>
                        <p class="dark:text-white">
                            {{ __('Account:') }}
                            <span class="fw-bold" id="update-forex-schema-modal-login"></span>
                        </p>
                    </div>
                ...
                <div class="p-6 space-y-4">
                    <!-- The AJAX loaded form or content will appear here -->
                    <div id="view_forex_schema_form"></div>
                </div>
            </div>
        </div>
    </div>
