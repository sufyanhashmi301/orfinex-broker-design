<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="depositDemo" tabindex="-1" aria-labelledby="depositDemo" aria-hidden="true">
                ...
                <div class="p-6 space-y-4">
                    <form action="{{route('user.deposit.demo.now')}}" method="post" id="deposit-demo-form">
                        ...
                        <div class="action-btns mt-4">
                            <button type="button" class="btn btn-primary inline-flex items-center justify-center mr-2" id="deposit-demo-account-submit">
                                {{ __('Deposit') }}
                            </button>
