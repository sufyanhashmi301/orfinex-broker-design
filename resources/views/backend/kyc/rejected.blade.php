...
@endsection
@section('filters')
    <form id="filter-form" method="POST" action="{{ route('admin.kyc.export',['type' => 'rejected']) }}">
        @csrf
...
@endsection
@section('style')
    @include('components.datatables.sort-icons', ['selector' => '#rejected-kyc-dataTable'])
@endsection
@section('script')
    <script>
        (function ($) {
            ...
            var table = $('#rejected-kyc-dataTable')
