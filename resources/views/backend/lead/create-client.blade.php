...
@endsection
@section('content')
    <form action="{{ route('admin.lead.storeAsClient') }}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card-body p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                                    ...
                                    <select name="country" id="countrySelect" class="select2 form-control w-full" data-placeholder="Select Country">
                                        ...
                                        @foreach( getCountries() as $country)
                                            <option value="{{ $country['name'].':'.$country['dial_code'] }}"
                                                    @if( $lead->country == $country['name']) selected @endif
                        ...
                        <div class="input-area relative">
                            ...
                            <input type="email" name="email" value="{{ $lead->client_email }}" class="form-control">
                            @error('email')
                        ...
                        <div class="input-area relative">
                            ...
                            <input type="text" name="zip_code" class="form-control" value="{{ $lead->postal_code }}">
                        </div>
                        <div class="input-area relative">
                            <label class="form-label">
                                {{ __('Address') }}
