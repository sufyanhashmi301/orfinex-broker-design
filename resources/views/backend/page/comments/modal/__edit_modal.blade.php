<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="commentEditModal" tabindex="-1" aria-labelledby="commentEditModal" aria-hidden="true">
    <div class="modal-dialog modal-lg top-1/2 !-translate-y-1/2 relative pointer-events-none">
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-dark bg-clip-padding rounded-md outline-none text-current">
            <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-700">
                <div>
                    <h3 class="text-xl font-medium dark:text-white capitalize mb-1">{{ __('Edit Comment') }}</h3>
                    <p class="text-slate-600 dark:text-slate-200">{{ __('Update selected comment entry') }}</p>
                </div>
