                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Recent Section') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-card">
                                ...
                                <div class="site-card-body">
                                    <form action="{{ route('admin.page.section.section.update') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="section_code" value="recent">
                                        ...
                                        <div class="site-input-groups row">
                                            <label for="" class="col-sm-3 col-label">{{ __('Recent Title Small') }}</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="site-input-groups row">
                                            <label for="" class="col-sm-3 col-label">{{ __('Recent Title Big') }}</label>
                                            <div class="col-sm-9">
                            ...
                            <div class="section-design-nb">
                                <strong>{{ __('NB:') }}</strong>{{ __('Recent Deposit and Withdraw Data will come from Automatic Recent Deposits and Withdraws') }}
                            </div>
                        </div>
                    </div>
                </div>
