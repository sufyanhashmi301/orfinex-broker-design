    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="card">
            <div class="card-body p-6">
                <form action="{{ route('admin.payment-deposit-form.update', $question->id) }}" method="post" class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div class="input-area">
                        ...
                        <input type="text" name="name" value="{{ old('name', $question->name) }}" class="form-control"
                            ...
                            <div class="flex items-center space-x-7 flex-wrap">
                                ...
                                <div class="form-switch ps-0">
                                    ...
                                    <label class="relative inline-flex h-6 w-[46px] items-center rounded-full transition-all duration-150 cursor-pointer">
                                        <input type="checkbox" name="status" value="1" class="sr-only peer" {{ old('status', $question->status) ? 'checked' : '' }}>
