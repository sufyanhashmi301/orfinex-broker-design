<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="createManualGroupModal" tabindex="-1" aria-labelledby="createManualGroupModal" aria-hidden="true">
    <div class="modal-dialog top-1/2 !-translate-y-1/2 relative w-auto pointer-events-none">
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-dark bg-clip-padding rounded-md outline-none text-current">
            <div class="modal-body popup-body">
                <div class="flex items-start justify-between gap-3 p-5">
                    <div>
                        <h3 class="text-xl font-medium dark:text-white capitalize mb-1">
                            {{ __('Create Platform Group') }}
                        </h3>
                        <p class="text-slate-600 dark:text-slate-200">
                            {{ __('Enter your information to create platform group') }}
                        </p>
                    </div>
                ...
                <div class="p-6 pt-3">
                    <form action="{{ route('admin.groups.storeManually') }}" method="post">
                        @csrf
                        ...
                        <div class="space-y-5">
                            <div class="input-area relative">
                                ...
                                <input type="text" name="group" class="form-control" placeholder="real\test">
                            </div>
                            <div class="input-area relative">
                                <label for="" class="form-label">
                                    {{ __('Currency') }}
                                ...
                                <select name="currency" class="form-control">
                                    ...
                                    <option value="JPY">{{ __('JPY') }}</option>
