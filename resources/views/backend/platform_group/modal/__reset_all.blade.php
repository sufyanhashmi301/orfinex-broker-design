<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        id="resetAllGroupsModal"
        tabindex="-1"
        aria-labelledby="resetAllGroupsModal"
        aria-hidden="true"
    >
                ...
                <div class="modal-body p-6 py-10 text-center">
                    <div class="space-y-3">
                        ...
                        <p class="dark:text-slate-300">
                            {{ __('This will reset and remove all platform groups (MT5 and Manual). This action cannot be undone.') }}
                        </p>
                    </div>
                    <form method="post" id="resetAllGroupsForm" action="{{ route('admin.groups.resetAll') }}">
                        @csrf
