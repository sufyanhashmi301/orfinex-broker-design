        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <p>{{ __('Manage your funded settings of the application.') }}</p>
                </div>
                <div class="nk-block-head-content">
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">{{ __('Set the order to display plan/scheme for funded.') }}</span>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
                                ...
                                <div class="notes">
                                    ...
                                    <ul>
                                        <li class="alert-note is-plain text-soft">
                                            ...
                                            <p><strong class="text-dark">{{ __("Each Times") }}</strong>: {{ __("Each time calculate the profit against any plan and adjust into funded account with admin action.") }}</p>
                                        </li>
                                        <li class="alert-note is-plain text-soft">
                                            <em class="icon ni ni-info"></em>
                                            <p><strong class="text-dark">{{ __("Threshold Amount") }}</strong>: {{ __("Adjust the funded account balance once calculated profits cross the amount specify above.") }}</p>
                                        </li>
                        ...
                        {{-- <div class="row g-3 align-center">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">{{ __('Set the date you have launched your funded site.') }}<br>{{ __('This will show the days of online.') }}</span>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">{{ __('Require or not admin confirmation to start funded plan.') }}</span>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
                        ...
                        <div class="row g-3 align-start">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <span class="form-note">{{ __('Temporarily disable the funded purchase feature.') }}<br>{{ __('It does not affect on any old or running funded plan.') }}</span>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
