                ...
                <form action="{{ url()->current() }}" method="GET">
                    <div class="search-wrap search-wrap-extend bg-lighter{{ (request()->get('query')) ? ' active' : '' }}" data-search="search">
                        <div class="search-content">
                            ...
                            <input type="text" name="query" value="{{ request()->get('query') }}" class="form-control border-transparent form-focus-none" placeholder="{{ __("Search by funded plan id") }}">
                    ...
                    <div class="card-inner p-0">
                        <table class="nk-plan-tnx table">
                            ...
                            <tr>
                                ...
                                <th class="tb-col"><span class="overline-title">{{ __('Paid') }}</span> <em class="icon ni ni-info nk-tooltip small text-soft" title="{{ __("The profit amount transfered to funded account or not.") }}"></em></th>
                            ...
                            <tr>
                                <td class="tb-col">
                                    ...
                                    <em class="icon ni ni-info nk-tooltip small text-soft" title="{{ __("Funded: :amount", ['amount' => money($profit->invested, base_currency()) ]) }}"></em>
                                </td>
                                <td class="tb-col">
                                    {{ $profit->invest->ivx }}
                                </td>
