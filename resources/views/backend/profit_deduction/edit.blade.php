                    ...
                    <div class="site-card">
                        <div class="site-card-body">
                            <form action="{{route('admin.schema.update',$schema->id)}}" method="post"
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Min Return Of Interest:') }}</label>
                                        <div class="position-relative">
                                            <input
                                                type="text"
                                                class="box-input"
                                                placeholder="Number"
                                                name="min_return_interest"
                                                value="{{$schema->min_return_interest}}"
                                                oninput="this.value = validateDouble(this.value)"
                                                required
                                            />
                                            <div class="prcntcurr">
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Max Return Of Interest:') }}</label>
                                        <div class="position-relative">
                                            <input
                                                type="text"
                                                class="box-input"
...
{{--                                            </div>--}}
                                ...
                                <div class="col-xl-6 cancel-expiry  @if(!$schema->schema_cancel) hidden @endif">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Cancel Expiry') .' (Max 59 Minutes):' }}</label>
                                        <div class="input-group joint-input">
                                            <input type="text" name="expiry_minute"
                                                   onkeypress="return validateNumber(event)"
                                                   value="{{ $schema->expiry_minute }}"
                                                   class="form-control"/>
                                            <span
