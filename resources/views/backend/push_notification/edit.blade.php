                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.template.notification.template-update') }}" method="post"
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Title') }}<i icon-name="info"
                                ...
                                <div class="site-input-groups row">
                                    <label for="" class="col-sm-3 col-label">{{ __('Message Body') }}<i icon-name="info"
                                                                                                        data-bs-toggle="tooltip"
                                                                                                        title=""
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="message_body" class="form-textarea" cols="30"
                                                  ...
                                                  <p class="paragraph mb-0 mt-2"><i
                                                    icon-name="alert-triangle"></i>{{ __('The Shortcuts you can use') }}
