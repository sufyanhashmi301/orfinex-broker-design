    ...
    <div class="max-w-5xl mx-auto">
        <div class="flex justify-between flex-wrap items-center mb-6">
            ...
            <div class="flex sm:space-x-4 space-x-2 sm:justify-end items-center rtl:space-x-reverse">
                <a href="{{ route('admin.template.notification.index') }}" class="btn btn-sm btn-primary inline-flex items-center justify-center">
        ...
        <div class="card">
            <div class="card-body p-6">
                <form action="{{ route('admin.template.notification.template-update') }}" method="post" enctype="multipart/form-data" class="space-y-5">
                    @csrf
