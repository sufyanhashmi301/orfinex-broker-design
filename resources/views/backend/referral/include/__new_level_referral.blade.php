                    ...
                    <div class="popup-body-text p-6 pt-0 space-y-5">
                        ...
                        <div class="input-area">
                            ...
                            <div class="joint-input relative">
                                ...
                                <span class="absolute right-0 top-1/2 -translate-y-1/2 w-9 h-full border-l border-l-slate-200 dark:border-l-slate-700 Inactive Accounts dark:text-slate-300 flex items-center justify-center">
                                    %
                                </span>
                            </div>
                        </div>
