                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="title-content">
                            <h2 class="title">{{ __('Add New Risk Profile Tag Form') }}</h2>
                ...
                <div class="col-xl-8">
                    <div class="site-card">
                        <div class="site-card-body">
                            <form action="{{ route('admin.risk-profile-tag.store') }}" method="post" class="row">
                                @csrf
                                ...
                                <div class="col-xl-12">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" class="box-input"
                                               placeholder="Risk Profile Tag Type Name" required/>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="site-input-groups">
                                        <label for="" class="box-input-label">{{ __('Details(Optional)') }}</label>
                                        <textarea name="desc" class="form-textarea mb-0" placeholder="Details"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="row">
