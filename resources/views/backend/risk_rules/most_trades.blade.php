...
@section('content')
    ...
    <div class="innerMenu card p-5 mb-3">
      <form action="{{ route('admin.risk-rule.most_trades') }}" method="GET" >
                        ...
                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="positions-table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="table-th">{{ __('Total Buy Trades') }}</th>
                                    <th scope="col" class="table-th">{{ __('Total Sell Trades') }}</th>
                            ...
                            <tbody>
                              @forelse ($data as $item)
                                <tr class="item-row" data-total-trades="{{ $item['totalTrades'] }}">
                                  ...
                                  <td class="table-td">{{ $item['totalBuyTrades'] }}</td>
                                  <td class="table-td">{{ $item['totalSellTrades'] }}</td>
