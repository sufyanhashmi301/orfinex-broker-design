                                ...
                                @foreach($permissions as $category => $permission)
                                    <div class="accordion-item">
                                        <h2 class="accordion-header text-lg" id="headingOne">
                                            <button class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-x-0 border-gray-200 dark:border-slate-700 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                                type="button"
                                                ...
                                                <div class="grid grid-cols-2 xl:grid-cols-4 gap-4">
                                                    ...
                                                    <div class="flex items-center justify-between p-5 border border-slate-100 dark:border-slate-700">
                                                        ...
                                                        <label class="relative inline-flex h-6 w-[46px] items-center rounded-full transition-all duration-150 cursor-pointer">
                                                            <input type="checkbox" class="sr-only peer" id="{{$raw->name}}" name="permission[]" value="{{$raw->id}}">
