...
@section('email-content')
    <div class="card">
        <div class="card-header noborder">
            <div class="flex-1">
                <h4 class="font-medium text-xl capitalize dark:text-white inline-block mb-1">{{ __('SendGrid Configuration') }}</h4>
                <p class="card-text">
                    {{ __('Configure your SendGrid server for reliable email delivery') }}
                </p>
            </div>
            ...
            <div class="font-normal text-sm rounded-md bg-white border border-secondary-500 dark:bg-slate-800 p-4">
                <div class="flex space-x-3">
                    ...
                    <p class="flex-1 text-sm dark:text-slate-300">
                        {{ __('SendGrid servers provide the most reliable way to send automated emails. We recommend using professional providers like SendGrid or Mailgun for best delivery rates.') }}
                    </p>
                </div>
            </div>
            <div class="mt-5">
                <ul class="space-y-5">
                    ...
                    <li class="bg-body dark:bg-body rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div class="flex-1 text-sm">
                                <h6 class="text-sm font-semibold dark:text-white mb-1">
                                    {{ __('Generate SendGrid Credentials') }}
                                </h6>
                                <p class="dark:text-slate-300">
                                    {{ __('Create and securely store your SendGrid credentials from your provider') }}
                                </p>
                            </div>
                        </div>
                    </li>
                    <li class="bg-body dark:bg-body rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div class="flex-1 text-sm">
                                ...
                                <p class="dark:text-slate-300">
                                    {{ __('Enter your SendGrid server details, port, encryption type, and authentication') }}
                                </p>
                            </div>
                        </div>
                    </li>
