<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    id="addManualMethodOption" tabindex="-1" aria-labelledby="addManualMethodOption" aria-hidden="true">
        ...
        <div
            ...
            <div class="modal-body popup-body">
                <div class="flex items-start justify-between gap-3 p-5">
                    <h5 class="modal-title" id="addManualMethodOptionLabel">{{ __('Add Option for Manual KYC') }}</h5>
                    <button type="button"
                ...
                <div class="p-6 pt-0 edit-plugin-section">
                    <form action="{{ route('admin.kyc_method.store') }}" method="post" class="space-y-3">
                        @csrf 
                        ...
                        <label class="form-label" for="">{{ __('Fields') }}</label>
                        ...
                        <div class="max-w-xs">
                            <div class="input-area">
                                ...
                                <div class="switch-field flex mb-3 overflow-hidden">
                                    <input type="radio" id="active-status-2" name="status" checked=""
                                        value="1" />
                                    <label for="active-status-2">{{ __('Active') }}</label>
                                    <input type="radio" id="deactivate-status-2" name="status" value="0" />
