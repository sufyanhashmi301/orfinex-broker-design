            ...
            <form action="" method="" enctype="multipart/form-data">
                <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
                    ...
                    <div class="input-area relative">
                        <label for="" class="form-label !flex items-center">
                            {{ __('Login') }}
                            <iconify-icon class="toolTip onTop ml-1" icon="lucide:info" data-tippy-content="This is the login credential required to authenticate and connect to the platform through the API."></iconify-icon>
                        </label>
                    ...
                    <div class="input-area relative">
                        <label for="" class="form-label !flex items-center">
                            {{ __('Password') }}
                            <iconify-icon class="toolTip onTop ml-1" icon="lucide:info" data-tippy-content="The password associated with the login credential for secure access to the platform."></iconify-icon>
                        </label>
