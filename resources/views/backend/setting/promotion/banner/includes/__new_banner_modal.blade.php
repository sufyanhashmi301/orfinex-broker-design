<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="new-banner-modal" tabindex="-1" aria-labelledby="new-banner-modalLabel" aria-modal="true"
    role="dialog">
    <div class="modal-dialog top-1/2 !-translate-y-1/2 relative w-auto pointer-events-none">
        <div
            class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
            <div class="flex items-center justify-between p-5">
                <h3 class="text-xl font-medium dark:text-white capitalize" id="new-banner-modalLabel">
                    Create New Banner
                </h3>
                <button type="button"
            ...
            <div class="modal-body p-6 pt-0">
                <form action="{{ route('admin.banner.store') }}" method="post" class="space-y-5">
                    @csrf
                    ...
                    <div class="input-area">
                        ...
                        <input type="text" name="button_text" class="form-control" value="">
                    </div>
                    <div class="input-area">
