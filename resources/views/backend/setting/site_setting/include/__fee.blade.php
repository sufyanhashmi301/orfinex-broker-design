        ...
        <div class="card-body p-6">
            ...
            <div class="input-area grid grid-cols-12 gap-5 mb-5">
                ...
                <div class="lg:col-span-8 col-span-12">
                    <div class="site-input-groups relative">
                        <div class="relative">
                            <input type="text" class="form-control" value="{{ oldSetting('send_charge','global') }}"
                                   name="send_charge">
                            <div class="prcntcurr absolute right-1 top-1/2 -translate-y-1/2 w-auto h-full text-sm h-full border-l border-l-slate-200 dark:border-l-slate-700">
                                <select name="send_charge_type" class="form-control w-100" id="">
            ...
            <div class="input-area grid grid-cols-12 gap-5 mb-5">
                ...
                <div class="lg:col-span-8 col-span-12">
                    <div class="site-input-groups relative">
                        <div class="relative">
                            <input type="text" class="form-control" value="{{ oldSetting('internal_send_charge','global') }}"
                                   name="internal_send_charge">
                            <div class="prcntcurr absolute right-1 top-1/2 -translate-y-1/2 w-auto h-full text-sm h-full border-l border-l-slate-200 dark:border-l-slate-700">
                                <select name="internal_send_charge_type" class="form-control w-100" id="">
                                    @foreach(['fixed' => setting('currency_symbol','global') , 'percentage' => '%'] as $key => $value)
                ...
                <div class="lg:col-span-8 col-span-12">
                    <div class="site-input-groups relative">
                        <div class="relative">
                            ...
                            <div class="prcntcurr absolute right-1 top-1/2 -translate-y-1/2 w-auto h-full text-sm h-full border-l border-l-slate-200 dark:border-l-slate-700">
                                <select name="wallet_exchange_charge_type" class="form-control w-100" id="">
                                    @foreach(['fixed' => setting('currency_symbol','global') , 'percentage' => '%'] as $key => $value)
