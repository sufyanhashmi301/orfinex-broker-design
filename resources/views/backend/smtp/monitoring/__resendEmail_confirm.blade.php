<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    ...
    tabindex="-1"
    aria-labelledby="confirmResendModal"
    aria-hidden="true"
>
            ...
            <div class="modal-body p-6 py-10 text-center">
                <div class="space-y-3">
                    ...
                    <p class="dark:text-slate-300">
                        {{ __('You want to resend this email') }}
                    </p>
                </div>
                <div class="action-btns mt-10">
                    <button type="submit" class="btn btn-dark inline-flex items-center justify-center mr-2" id="confirmResendButton">
