        ...
        <div class="card-body p-6">
            <div class="grid lg:grid-cols-3 grid-cols-1 gap-5">
                ...
                <div class="input-area">
                    ...
                    <input type="text" name="date_of_joining" class="form-control flatpickr flatpickr-input" placeholder="2018-12-19">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body p-6">
            <div class="grid lg:grid-cols-3 grid-cols-1 gap-5">
                <div class="input-area">
                    ...
                    <input type="text" name="date_of_joining" class="form-control flatpickr flatpickr-input" placeholder="2006-12-19">
                </div>
                <div class="input-area">
