    ...
    <div class="card">
                    ...
                    <div class="lg:col-span-2">
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">
                            ...
                            <div class="input-area !mt-0">
                                ...
                                <input type="text" name="name" class="form-control mb-0" value="{{ $staff->name }}"
                            ...
                            <div class="input-area">
                                ...
                                <input type="number" name="employee_id" class="form-control mb-0"
                                    value="{{ $staff->employee_id }}" placeholder="Employee ID" />
                            </div>
                            @if (auth()->user()->hasRole('Super-Admin'))
                                <div class="input-area">
                                    <label for="key" class="form-label">
                                        <span class="shift-Away inline-flex items-center gap-1"
                                            data-tippy-content="The key of the staff">
                                            {{ __('Key') }}
                                            <iconify-icon icon="mdi:information-slab-circle-outline"
                                                class="text-[16px]"></iconify-icon>
                                        </span>
                                    </label>
                                    <input type="text" id="key" name="key" class="form-control mb-0"
                                        value="{{ $staff->key ?? '' }}" placeholder="Enter unique key" />
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="wrap-custom-file h-full">
                            ...
                            <label for="profile-avatar">
                                <img class="upload-icon"
                                    src="{{ getFilteredPath($staff->avatar, 'fallback/staff.png') }}" alt="" />
                    ...
                    <div class="grid lg:grid-cols-3 grid-cols-1 gap-5">
                        ...
                        <div class="input-area">
                            ...
                            <select name="employment_status" class="select2 form-control w-100">
                                ...
                                <option value="notice period" @selected($staff->employment_status === 'notice period')>{{ __('Notice Period') }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="input-area">
                            ...
                            <input type="text" name="date_of_joining" class="form-control flatpickr"
                ...
                <div class="card-body p-6">
                    <div class="grid lg:grid-cols-3 grid-cols-1 gap-5">
                        ...
                        @canany(['staff-branch-assign', 'staff-branch-view'])
                            @if ($staff->roles[0]['name'] !== 'Super-Admin')
                                <div class="input-area">
                                    <label class="form-label" for="">
                                        <span class="shift-Away inline-flex items-center gap-1"
                                        ...
                                        <select name="branch_id" class="select2 form-control w-100">
                                            ...
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}"
                                                    {{ $staff->branches && $staff->branches->first() && $staff->branches->first()->id == $branch->id ? 'selected' : '' }}>
                                    ...
                                    @else
                                        <div class="form-control bg-slate-50 dark:bg-slate-700">
                                            @if ($staff->branches && $staff->branches->count() > 0)
                                                <span class="badge badge-secondary">{{ $staff->branches->first()->name }}
                                                    ({{ $staff->branches->first()->code }})
                                                </span>
                                            @else
                ...
                <div class="grid lg:grid-cols-3 grid-cols-1 gap-5">
                    <div class="input-area">
                        ...
                        <input type="text" name="date_of_birth" class="form-control flatpickr dateOfBirth"
                            value="{{ $staff->date_of_birth }}" placeholder="2006-12-19">
                    </div>
                    <div class="input-area">
                        <label for="" class="form-label">
                            <span class="shift-Away inline-flex items-center gap-1"
                    ...
                    <div class="input-area">
                        ...
                        <input type="text" name="work_phone" class="form-control" value="{{ $staff->work_phone }}"
                            placeholder="">
                    </div>
                    <div class="input-area">
                        <label for="" class="form-label">
        ...
        @if (!$staff->hasRole('Super-Admin'))
            ...
            <div class="card-body p-6">
                <div class="input-area">
                    <div class="relative">
                        <input type="text" class="form-control !pr-32" id="referral-input"
                            value="{{ $staff->link }}" readonly>
                        <span
