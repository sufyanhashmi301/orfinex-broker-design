                ...
                <form action="{{ route('admin.user.balance-update',$user->id) }}" method="post" class="space-y-5">
                    ...
                    <div class="input-area">
                        <div class="joint-input relative">
                            <span class="absolute text-sm left-0 top-1/2 -translate-y-1/2 h-full border-r border-r-slate-200 dark:border-r-slate-700 flex items-center justify-center px-2">
