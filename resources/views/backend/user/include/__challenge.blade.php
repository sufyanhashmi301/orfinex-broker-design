<div class="tab-pane space-y-5 fade" id="pills-challenge" role="tabpanel" aria-labelledby="pills-challenge-tab">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{ __('Challenge Accounts') }}</h4>
        </div>
            ...
            <div class="overflow-x-auto -mx-6 dashcode-data-table">
                ...
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden ">
                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="challengeAccount-dataTable">
                            <thead>
                                <tr>
                                    <th scope="col" class="table-th">{{ __('login') }}</th>
                                    <th scope="col" class="table-th">{{ __('Account Type') }}</th>
                                    <th scope="col" class="table-th">{{ __('Phase') }}</th>
...
@push('single-script')
    <script>
        (function ($) {
            "use strict";
            var table = $('#challengeAccount-dataTable').DataTable();
            table.destroy();
            var table = $('#challengeAccount-dataTable').DataTable({
