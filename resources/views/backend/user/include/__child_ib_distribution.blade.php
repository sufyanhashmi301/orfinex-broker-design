<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="child-ib-modal" tabindex="-1" aria-labelledby="child-ib-modal-label" aria-hidden="true">
    <div class="modal-dialog top-1/2 !-translate-y-1/2 relative w-auto pointer-events-none">
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-dark bg-clip-padding rounded-md outline-none text-current">
            <form id="master-ib-form" action="{{ route('admin.user.child-ib-distribution', $user->id) }}" method="POST">
                @csrf
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                <iconify-icon icon="mdi:calendar" class="text-gray-400"></iconify-icon>
                            </div>
                        </div>
                    </div>
