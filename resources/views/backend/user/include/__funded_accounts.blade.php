...
<div class="tab-pane fade" id="funded-accounts" role="tabpanel">
    <div class="card">
                ...
                <div class="inline-block min-w-full align-middle">
                    <div style="padding-top: 5px" class="overflow-hidden basicTable_wrapper" style="height: 723px; overflow: auto">
                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                            ...
                            <tbody>
                                @forelse ($funded_accounts as $investment)
                                    @php
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8"> <center><small>No funded account!</small></center> </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
