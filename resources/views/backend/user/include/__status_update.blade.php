<div class="profiel-wrap px-[35px] pb-10 pt-10 rounded-lg bg-white dark:bg-slate-800 lg:space-y-0 space-y-6 relative z-[1]">
    <div class="bg-slate-900 dark:bg-slate-700 absolute left-0 top-0 h-[150px] w-full z-[-1] rounded-t-lg">
    </div>
    <div class="profile-box">
        ...
        <div class="text-center border-t border-b border-slate-100 dark:border-slate-700 py-4 mb-5">
