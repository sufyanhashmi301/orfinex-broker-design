@extends('backend.withdraw.accounts_index')
@section('title')
    {{ __('Approved Withdraw Accounts') }}
@endsection
@section('page-title')
...
@endsection
@section('filters')
    <form id="filter-form" method="POST" action="{{ route('admin.withdraw.approved.accounts.export') }}">
        @csrf
...
@section('withdraw_content')
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="account-action-modal" tabindex="-1" aria-labelledby="account-action-modal" aria-hidden="true">
        <div class="modal-dialog modal-lg top-1/2 !-translate-y-1/2 relative max-w-xl w-full pointer-events-none">
            <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-dark bg-clip-padding rounded-md outline-none text-current">
                <div class="modal-body popup-body">
                    <div class="popup-body-text account-action">
    ...
    <script>
        (function ($) {
            ...
            .on('processing.dt', function (e, settings, processing) {
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.withdraw.approved.accounts') }}",
                    data: function (d) {
            ...
            $('body').on('click', '.account-action-btn', function () {
