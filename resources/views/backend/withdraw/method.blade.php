                    ...
                    @can('withdraw-method-action')
                        <div class="dropdown relative">
                            ...
                            <ul
                                ...
                                <li>
                                    <a href="{{ route('admin.withdraw.method.edit', ['type' => strtolower($type), 'id' => $method->id]) }}"
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                        class="delete-method text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white"
                ...
                <div class="card-body p-4 pt-2">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center justify-between text-sm">
                            ...
                            <span
                                class="capitalize">{{ $method->required_time . ' ' . $method->required_time_format }}</span>
                        </li>
                        <li class="flex items-center justify-between text-sm">
