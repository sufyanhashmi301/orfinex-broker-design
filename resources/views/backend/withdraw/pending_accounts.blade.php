...
@endsection
@section('filters')
    <form id="filter-form" method="POST" action="{{ route('admin.withdraw.pending.accounts.export') }}">
        @csrf
    ...
    <script>
        (function ($) {
            ...
            .on('processing.dt', function (e, settings, processing) {
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.withdraw.pending.accounts') }}",
                    data: function (d) {
