...
@endsection
@section('filters')
    <form id="filter-form" method="POST" action="{{ route('admin.withdraw.rejected.accounts.export') }}">
        @csrf
    ...
    <script>
        (function ($) {
            ...
            .on('processing.dt', function (e, settings, processing) {
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.withdraw.rejected.accounts') }}",
                    data: function (d) {
