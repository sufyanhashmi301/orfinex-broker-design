    ...
    >
        ...
        <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
            <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
                ...
                <div class="relative items-center bg-cover bg-no-repeat bg-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2"
                    ...
                    <div class="flex items-center justify-center z-1">
                        <div class="flex flex-col items-center max-w-xs">
                            <a href="index.html" class="block mb-4">
                                <img src="{{ getFilteredPath(setting('site_logo', 'global'), 'fallback/branding/desktop-logo.png') }}" alt="Logo" />
                            </a>
                        </div>
                    </div>
                </div>
