<div x-data="{openDropDown: false}" class="dropdown-menu relative leading-none h-fit">
    <button @click="openDropDown = !openDropDown" :class="openDropDown ? 'text-gray-700 dark:text-white' : 'text-gray-400 hover:text-gray-700 dark:hover:text-white'" class="text-gray-400 hover:text-gray-700 dark:hover:text-white" type="button" data-bs-toggle="dropdown" aria-expanded="false">
