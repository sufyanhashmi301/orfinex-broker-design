                ...
                <div class="list-view-layout p-6">
                    ...
                    <div class="flex flex-wrap gap-3 justify-between items-center mt-5">
                        ...
                        <div class="action-btns flex items-center gap-3">
                            ...
                            <a href="javascript:;" class="flex justify-center items-center gap-2 px-4 py-2 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
