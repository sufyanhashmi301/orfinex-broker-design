<div
    x-show="$store.modals.isOpen('unarchiveAccount')"
    x-transition
    ...
    <div @click.away="$store.modals.close()" class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
        <div class="text-center">
            ...
            <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">
                {{ __('If you unarchive this account you can update info/use') }}
            </p>
            <form @submit.prevent="$store.modals.unarchiveAccount($refs)">
