            ...
            <div class="overflow-hidden">
                <div class="inline-flex items-center shadow-theme-xs">
                    <a href="{{ route('user.setting.profile') }}" 
                       ...
                       class="inline-flex items-center gap-2 px-4 py-2 text-sm text-nowrap font-medium ring-1 ring-inset ring-gray-300 transition first:rounded-l-lg last:rounded-r-lg dark:bg-white/[0.03] dark:ring-gray-700">
                        {{ __('Profile') }}
                    </a>
