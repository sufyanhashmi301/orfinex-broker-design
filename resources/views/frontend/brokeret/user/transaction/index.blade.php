...
@section('content')
        ...
        <div x-data="transactionFilter()" class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-gray-200 px-4 py-5 xl:px-6 xl:py-6 dark:border-gray-800">
            ...
            <div class="flex-1 flex flex-col sm:flex-row sm:justify-end sm:items-center gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <x-forms.button type="button" class="flex-1" variant="secondary" icon="x" icon-position="left" size="sm" @click="clearFilters()" x-show="Object.values(filters).some(v => v !== '')">
                        {{ __('Clear') }}
                    </x-forms.button>
                    ...
                    <form method="POST" action="{{ route('user.history.transactions.export') }}" class="flex-1">
                        ...
                        <x-forms.button type="submit" class="w-full" variant="outline" icon="arrow-up-from-dot" icon-position="left" size="sm">
                            {{ __('Export') }}
                        </x-forms.button>
                    </form>
                </div>
    ...
    <div class="md:hidden block mobile-screen-show mt-3">
        <!-- Transactions -->
        @if(count($transactions) == 0)
