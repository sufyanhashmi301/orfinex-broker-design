<div class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto modal z-99999"
    ...
    :class="{ 'hidden': !isCancelModalOpen }"
    @keydown.escape="isCancelModalOpen = false"
        ...
        <div class="text-center">
            <div class="relative flex items-center justify-center z-1 mb-7">
                ...
                <span class="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
                    <svg class="fill-warning-600 dark:fill-orange-400" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-center justify-center w-full gap-3 mt-7">
                <button type="button" @click="confirmCancel" class="inline-flex items-center gap-2 w-full px-5 py-3.5 text-sm font-medium text-white rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600 sm:w-auto">
                    <i data-lucide="check" class="w-4 h-4"></i>
                    {{ __('Confirm') }}
                </button>
                <a href="javascript:;" @click="isCancelModalOpen = false" class="inline-flex items-center gap-2 rounded-lg bg-white px-5 py-3.5 text-sm font-medium text-gray-700 shadow-theme-xs ring-1 ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
