        ...
        <div class="text-center">
            ...
            <form method="post" class="mt-5" @submit.prevent="submitOtp">
                ...
                <div class="flex items-center justify-center w-full gap-3 mt-7">
                    <button type="submit" x-ref="submitBtn" class="inline-flex items-center gap-2 w-full px-5 py-3.5 text-sm font-medium text-white rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600 sm:w-auto">
                        <i data-lucide="check" class="w-4 h-4"></i>
                        {{ __('Verify OTP') }}
                    </button>
                    <a href="javascript:;" @click="showCancelModal" class="inline-flex items-center gap-2 rounded-lg bg-white px-5 py-3.5 text-sm font-medium text-gray-700 shadow-theme-xs ring-1 ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
