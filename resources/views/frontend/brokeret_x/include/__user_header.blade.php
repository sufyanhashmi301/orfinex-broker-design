    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="{{ route('home') }}" class="lg:hidden">
                ...
                <img class="h-10 hidden dark:block" src="{{ getFilteredPath(setting('site_logo_dark', 'global'), 'fallback/branding/desktop-logo.png') }}" alt="Logo" />
            </a>
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                @auth
                    ...
                    <div class="relative user-notifications{{$userId}}" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                        @include('frontend.brokeret.include.__notification_data',['notifications'=>$notifications,'totalUnread'=>$totalUnread,'totalCount'=>$totalCount])
                    </div>
                @endauth
                <!-- Notification Menu Area -->
            </div>
