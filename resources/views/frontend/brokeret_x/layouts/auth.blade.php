<!doctype html>
<html lang="en">
     @include('frontend.brokeret.include.__head')
    <body
        ...
        <div class="flex flex-col h-screen">
            <!-- ========== HEADER ========== -->
            <header class="fixed top-0 inset-x-0 z-48 w-full bg-white border-b border-gray-200 text-sm py-2.5 dark:bg-slate-800 dark:border-slate-700">
                <div class="flex justify-between items-center px-4 sm:px-6 lg:px-8">
                    ...
                    <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="#">
                        <img src="{{ getFilteredPath(setting('site_logo', 'global'), 'fallback/branding/desktop-logo.png') }}" class="h-10 dark:hidden" alt="Logo" />
                        <img src="{{ getFilteredPath(setting('site_logo_dark', 'global'), 'fallback/branding/desktop-logo.png') }}" class="h-10 hidden dark:block" alt="Logo" />
                    </a>
                    <!-- End Logo -->
            ...
            <!-- ===== Page Wrapper Start ===== -->
            <div class="flex-1 relative p-6 bg-white z-1 dark:bg-gray-900 sm:py-8 sm:px-6 mt-[var(--header-height-mobile)] sm:mt-[var(--header-height)] overflow-y-auto">
