                ...
                <div class="input-area">  
                    ...
                    <div class="relative">
                        <x-frontend::forms.input 
                            x-ref="nickname"
                            x-model="$store.modals.data.account_name"
                            type="text"
                            fieldId="nickname"
                            fieldName="nickname"
                            fieldRequired="true"
                        ...
                        <small class="text-gray-500 dark:text-gray-400 mt-1">
                            {{ __('The name you want to update to remember.') }}
                        </small>
                    </div>
                </div>

                <div class="space-x-2 mt-4">
                    <x-frontend::forms.button type="submit" x-ref="submitBtn" variant="primary" size="md" icon="check" iconPosition="left">
                        {{ __('Rename Account') }}
