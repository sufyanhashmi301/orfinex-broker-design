                ...
                <div class="card-body p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        @if(setting('web_terminal_show','platform_links',false))
                            <a href="{{setting('web_terminal_link','platform_links','javascript:void(0);')}}" class="btn btn-sm btn-dark inline-flex items-center justify-center w-full h-10" target="_blank">
                                Trade on web trader
                            </a>
                        @endif
                        @if(setting('desktop_terminal_windows_show','platform_links',false))
                            <a href="{{setting('desktop_terminal_windows_link','platform_links','javascript:void(0);')}}" class="btn btn-sm btn-outline-dark inline-flex items-center justify-center w-full h-10" target="_blank">
                                Download MT 5
                            </a>
                        @endif
                        <a href="{{ route('user.certificates') }}" class="btn btn-sm btn-danger inline-flex items-center justify-center w-full h-10">
