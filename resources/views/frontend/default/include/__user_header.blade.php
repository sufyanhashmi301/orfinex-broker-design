        ...
        <div class="flex justify-between items-center h-full">
            <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                ...
                <div class="relative gap-2 lg:gap-5 hidden lg:flex">
                    <a href="{{ route('user.economic_calendar') }}"
                        class="inline-flex items-center text-sm text-gray-700 dark:text-slate-100 rounded px-3 py-1 hover:text-gray-800 hover:bg-slate-100 dark:hover:bg-slate-900">
                        <iconify-icon icon="lucide:calendar-days"
                            class="text-lg mr-2 hidden xl:inline-block"></iconify-icon>
                        Economic Calendar
                    </a>
                    <a href="{{ route('user.downloads') }}"
                        class="inline-flex items-center text-sm text-gray-700 dark:text-slate-100 rounded px-3 py-1 hover:text-gray-800 hover:bg-slate-100 dark:hover:bg-slate-900">
                        <iconify-icon icon="lucide:download-cloud"
                            class="text-lg mr-2 hidden xl:inline-block"></iconify-icon>
                        Downloads
                    </a>
            ...
            <div class="nav-tools flex items-center lg:space-x-5 space-x-3 rtl:space-x-reverse leading-0">
                ...
                <div class="md:block hidden w-full">
                    ...
                    <!-- Dropdown menu -->
                    <div
                        class="dropdown-menu z-10 hidden bg-white divide-y divide-slate-100 shadow min-w-max dark:bg-slate-800 border dark:border-slate-700 !top-[23px] rounded-md overflow-hidden">
                        <ul class="py-1 text-sm text-slate-800 dark:text-slate-200">
                            <li>
