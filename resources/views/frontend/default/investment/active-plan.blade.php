            ...
            <div class="card top-24" id="account_credentials_card">
                <div class="card-body p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="https://webtrading.orfinex.com/terminal" class="btn btn-sm btn-dark inline-flex items-center justify-center w-full h-10">
                            Trade on web trader
                        </a>
                        <a href="{{route('user.downloads')}}" class="btn btn-sm btn-outline-dark inline-flex items-center justify-center w-full h-10">
                            Download MT 5
                        </a>
                        <a href="javascript:;" class="btn btn-sm btn-danger inline-flex items-center justify-center w-full h-10" data-bs-toggle="modal" data-bs-target="#certificateModal" onclick="submit_form('','','{{route('user.pricing.plan.certificate',the_hash(data_get($invest,'id')))}}','certificateImage')" data-image="{{asset('frontend/images/orfinexcertificate.png')}}">
