<div class="card mb-3">
    <div class="card-body p-6">
        ...
        <p class="card-text mb-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Exercitationem tempora, esse totam assumenda enim amet blanditiis cupiditate! Error quibusdam sit quam laborum ipsam! In, consectetur animi expedita vero soluta fuga.</p>
    ...
    <div class="card mb-3">
                ...
                <ul class="nav nav-pills flex items-center flex-wrap list-none pl-0 space-x-4" id="tabs-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="#tabs-socialMediaMaterial"
                            ...
                            id="tabs-socialMediaMaterial-tab" data-bs-toggle="pill" data-bs-target="#tabs-socialMediaMaterial" role="tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#tabs-websiteBanners"
                            ...
                            id="tabs-websiteBanners-tab" data-bs-toggle="pill" data-bs-target="#tabs-websiteBanners" role="tab"
        ...
        <div class="card-body p-6">
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tabs-socialMediaMaterial" role="tabpanel" aria-labelledby="tabs-socialMediaMaterial-tab">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                        <div class="card card-cover h-100 overflow-hidden relative rounded-4"
                            style="background-image: url({{ asset('frontend/images/unsplash-photo-2.jpg') }});min-height: 275px;background-size: cover;">
                            <div class="absolute right-0">
                                <a href="" class="btn inline-flex h-12 w-12 items-center justify-center btn-light rounded-none">
                ...
                <div class="tab-pane fade" id="tabs-websiteBanners" role="tabpanel" aria-labelledby="tabs-websiteBanners-tab">
