...
{{--                    @if(count($realForexAccounts) == 0 && count($demoForexAccounts) == 0)--}}
                        <div class="relative bg-gradient-to-tr from-secondary to-primary text-center space-y-3 rounded-lg px-6 py-4">
                            ...
                            <p class="text-lg">
                                With World’s Best Prop Trading Conditions
                            </p>
                            <div class="flex flex-wrap items-center justify-center gap-5">
                                <div class="flex items-center bg-white rounded-lg py-2 px-3">
                                    <img src="assets/images/check-icon.svg" alt="">
                                    <p class="text-sm ms-2">No Time Limit</p>
                                </div>
                                <div class="flex items-center bg-white rounded-lg py-2 px-3">
                                    <img src="assets/images/check-icon.svg" alt="">
                                    <p class="text-sm ms-2">Balance Based Drawdown</p>
                                </div>
                                <div class="flex items-center bg-white rounded-lg py-2 px-3">
                                    <img src="assets/images/check-icon.svg" alt="">
                                    <p class="text-sm ms-2">80% Profit Share from Funded Accounts</p>
                                </div>
                            </div>
                        </div>
{{--                    @else--}}
