                    ...
                    <form action="#" class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                            <div class="single-box">
                                ...
                                <select name="selectCalculationPlan" id="selectPlan"
                                        class="site-nice-select plan-selects mb-4">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                            <div class="single-box mb-0">
                                <a href="{{ route('user.invest-now') }}" type="submit" class="mt-2 site-btn-big primary-btn w-100 centered"><i icon-name="user"></i>{{ __('Invest Now') }}</a>
                            </div>
                        </div>
