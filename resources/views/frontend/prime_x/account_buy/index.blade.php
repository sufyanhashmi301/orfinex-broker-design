...
@section('content')
    ...
    <div class="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 mb-10">
        @foreach($account_types as $account_type)
            ...
            @php
                $no_of_accounts = \App\Models\AccountTypeInvestment::where('user_id', Auth::id())
                ...
                <div class="card-body p-6">
                    <div class="mb-5">
                        <div class="flex items-center justify-between mb-1">
                            <h4>{{ $account_type->title }}</h4>
                            @if($account_type->badge)
                        ...
                        <p class="text-sm text-success-500 mb-2">
                            {{ __('Available in countries: ') }} {{ implode(', ', json_decode($account_type->countries,true)) }}
                        </p>
