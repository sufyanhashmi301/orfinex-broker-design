            ...
            <div class="grid xl:grid-cols-2 grid-cols-1 gap-5">
                <div class="card border hover:shadow-lg">
                    <div class="card-header items-center !p-4">
                        <div class="flex items-center">
                            <div class="h-10 w-10 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                                <img src="{{ asset('frontend/images/perfectMoney.svg') }}" alt="user" class="block w-full h-full object-cover rounded-full">
                            </div>
                    ...
                    <div class="card-body p-4">
                        <ul class="space-y-3">
                            <li class="text-sm">
                                <span class="text-slate-400 mr-1">Processing Time</span>
                                <span>Instant - 30 minutes</span>
                            </li>
                            <li class="text-sm">
                                <span class="text-slate-400 mr-1">Fee</span>
                                <span>0%</span>
                            </li>
                            <li class="text-sm">
                                <span class="text-slate-400 mr-1">Limits</span>
                ...
                <div class="card border hover:shadow-lg">
                    <div class="card-header items-center !p-4">
                        <div class="flex items-center">
                            <div class="h-10 w-10 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                                <img src="{{ asset('frontend/images/binancePay.svg') }}" alt="user" class="block w-full h-full object-cover rounded-full">
                            </div>
                            <span class="flex-none text-slate-900 dark:text-white text-lg text-ellipsis whitespace-nowrap">
                                BinancePay
                            </span>
