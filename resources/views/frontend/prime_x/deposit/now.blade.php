                            ...
                            <div class="input-area relative conversion hidden">
                                ...
                                <div class="relative">
                                    <input type="text" class="form-control !text-lg"
                                        ...
                                        id="converted-amount" aria-describedby="basic-addon2">
                                    <span
                                        class="absolute right-0 top-1/2 px-3 -translate-y-1/2 h-full border-l border-l-slate-200 dark:border-l-slate-700 dark:text-slate-100 flex items-center justify-center"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#amount').on('keyup', function(e) {
                ...
                $('.pay-amount').text(parseFloat((total * globalData.rate).toFixed(4)).toString() + ' ' +
                    globalData.currency)
            ...
            $('#converted-amount').on('keyup', function(e) {
                ...
                $('.pay-amount').text(parseFloat((total * globalData.rate + ' ' + globalData.currency)
                    .toFixed(4)).toString());
