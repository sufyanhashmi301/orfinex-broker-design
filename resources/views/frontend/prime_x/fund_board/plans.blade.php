            ...
            <div class="payment-plans-head mb-3">
                <div class="payment-plans-row flex gap-3 items-end w-full">
                    ...
                    <div class="card payment-plans-cell flex flex-col justify-center w-1/5 text-center rounded-xl p-4 bg-white">
                        <h5 class="title text-slate-900 dark:text-white">{{ __('Beginner') }}</h5>
                        <div class="pricing-amount">
                            <div class="amount text-slate-600 dark:text-slate-100 mb-2">
                                <strike>{{ __('$597') }}</strike> /<span> {{ __('$478') }}</span>
                            </div>
                    ...
                    <div class="card payment-plans-cell flex flex-col justify-center w-1/5 text-center rounded-xl p-4 bg-white">
                        <h5 class="title text-slate-900 dark:text-white">{{ __('Skilled') }}</h5>
                        <div class="pricing-amount">
                            <div class="amount text-slate-600 dark:text-slate-100 mb-2">
                                <strike>{{ __('$1017') }}</strike> /<span> {{ __('$814') }}</span>
                            </div>
                            <form class="form" action="" method="POST" id="funded-scheme-form">
                                <a href="javascript:void(0);" data-url="" class="btn btn-sm btn-dark inline-flex items-center justify-center w-full invest-btn">
                                    {{ __('Get Funded') }}
                    ...
                    <div class="card payment-plans-cell flex flex-col justify-center w-1/5 text-center rounded-xl p-4 bg-white">
                        <h5 class="title text-slate-900 dark:text-white">{{ __('Specialist') }}</h5>
                        <div class="pricing-amount">
                            <div class="amount text-slate-600 dark:text-slate-100 mb-2">
                                <strike>{{ __('$1497') }}</strike> /<span> {{ __('$1198') }}</span>
                            </div>
                            <form class="form" action="" method="POST" id="funded-scheme-form">
                                <a href="javascript:void(0);" data-url="" class="btn btn-sm btn-dark inline-flex items-center justify-center w-full invest-btn">
                                    {{ __('Get Funded') }}
                    ...
                    <div class="card payment-plans-cell flex flex-col justify-center w-1/5 text-center rounded-xl p-4 bg-white">
                        <h5 class="title text-slate-900 dark:text-white">{{ __('Champion') }}</h5>
                        <div class="pricing-amount">
                            <div class="amount text-slate-600 dark:text-slate-100 mb-2">
                                <strike>{{ __('$2397') }}</strike> /<span> {{ __('$1918') }}</span>
                            </div>
                            <form class="form" action="" method="POST" id="funded-scheme-form">
                                <a href="javascript:void(0);" data-url="" class="btn btn-sm btn-dark inline-flex items-center justify-center w-full invest-btn">
                                    {{ __('Get Funded') }}
            ...
            <div class="card payment-plans-body">
                <div class="payment-plans-row__container">
                    <div class="payment-plans-row flex items-center w-full h-[65px] cursor-pointer hover:shadow-md">
                        ...
                        <div class="payment-plans-cell text-slate-600 dark:text-slate-100 w-1/5 text-center px-3">
                            <span>{{ __('100,000 $') }}</span>
                        </div>
                    </div>
                    <div class="plan-details text-slate-600 dark:text-slate-100 p-4 hidden">
                        <span>{{ __('Buying power refers to the maximum amount of margin that can be utilized, serving as an indicator of one\'s leverage potential. It provides insight into the extent to which an individual or entity can increase their purchasing or funded capacity through borrowed funds.') }}</span>
                    </div>
                </div>
            </div>
        </div>
