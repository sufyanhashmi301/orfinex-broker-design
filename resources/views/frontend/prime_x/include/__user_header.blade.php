...
{{--            @endif--}}
            ...
            <div class="nav-tools flex items-center lg:space-x-5 space-x-3 rtl:space-x-reverse leading-0 ml-auto">
                ...
                <div>
                    <button class="item notification-dot lg:h-[32px] lg:w-[32px] lg:bg-slate-100 lg:dark:bg-slate-900 dark:text-white text-slate-900 cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center" type="button" data-toggle="fullscreen">
                        <iconify-icon class="text-slate-800 dark:text-white text-xl" icon="mdi:fullscreen"></iconify-icon>
                    </button>
                </div>
