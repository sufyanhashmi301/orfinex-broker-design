    ...
    <main class="app-wrapper">
        ...
        <div class="flex flex-col justify-between min-h-screen">
            ...
            <footer class="md:block hidden sticky bottom-0" id="footer">
                <div class="site-footer px-6 text-slate-500 dark:text-slate-100 py-4 ltr:ml-[248px] rtl:mr-[248px]"
                    style="height: 48px;">
                    <div class="grid md:grid-cols-2 grid-cols-1 md:gap-5">
                        ...
                        <div class="ltr:md:text-right rtl:md:text-end text-center text-sm">
                            <span class="toolTip onTop" style="line-height: 0"
                                data-tippy-content="Your data is fully secure with advanced end-to-end encryption between you and your broker, ensuring that all sensitive client information and trading activities remain confidential. Technology Provider guarantees no access to or visibility of your encrypted data, safeguarding your privacy and trust.">
            ...
            <div class="mobile-screen-show md:hidden">
                <div
                    class="bg-white bg-no-repeat custom-dropshadow footer-bg dark:bg-slate-700 flex justify-around items-center backdrop-filter backdrop-blur-[40px] fixed left-0 bottom-0 w-full z-[9999] bothrefm-0 py-[12px] px-4">
        ...
        @php
            ...
            if ($user) {
                ...
                $hasStaffReferral = \Illuminate\Support\Facades\DB::table('staff_user')
                ...
                if (empty($userBranchId) && !$hasUserReferral && !$hasStaffReferral && !empty($user->country)) {
                    ...
                    if (!empty($code)) {
                        ...
                        if ($bc) {
                            $form = \App\Models\BranchForm::where('branch_id', $bc->branch_id)
                                ->where('status', 1)
                                ->first();
                            if ($form) {
                                $existingSubmission = \App\Models\BranchFormSubmission::where('user_id', $user->id)
                                    ->where('branch_id', $bc->branch_id)
                                    ->first();
