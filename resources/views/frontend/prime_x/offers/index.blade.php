        ...
        <div class="card-body px-6 pb-6">
            <div class="md:flex mb-6 md:space-y-0 space-y-4">
                ...
                <div class="flex items-center space-x-2 sm:rtl:space-x-reverse md:flex hidden">
                    <button type="button" class="btn btn-outline-dark btn-sm flex items-center justify-center grid-view-btn  active" data-target="offers-list">
                        <iconify-icon class="text-xl" icon="heroicons:view-columns"></iconify-icon>
                    </button>
                    <button type="button" class="btn btn-outline-dark btn-sm flex items-center justify-center list-view-btn" data-target="offers-list">
                ...
                <div class="grid 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3 h-max">
                    <div class="card rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 group">
                        <main class="card-body p-4 rounded-md">
                            <div class="dark:rounded relative h-[191px] flex flex-col justify-center items-center mb-3 rounded-md bg-cover product-image" style="background-image: url(https://cloud.orfinex.com/crm/offer1.png)">
                                <div class="h-[146px]">
