                    ...
                    <div class="list-view-layout p-6">
                        ...
                        <div class="flex justify-between items-center mt-3">
                            <p class="account-balance mb-0 dark:text-white">
                                <span class="text-lg font-semibold">{{ get_mt5_account_balance($account->login) }}
                                </span>
                            ...
                            <div class="action-btns flex items-center gap-3">
                                <a href="{{ route('user.deposit.methods') }}"
                                    class="btn btn-sm btn-outline-dark loaderBtn mt-0">
