...
<div class="grid grid-cols-3 gap-2 mob-shortcut-btn mb-3">
    <a href="{{ route('user.deposit.methods') }}" class="card rounded-md p-4 px-2 text-center dark:text-white">
        <div class="mx-auto text-2xl">
            <iconify-icon icon="heroicons-outline:download"></iconify-icon>
        </div>
        <span class="text-sm">{{ __('Deposit') }}</span>
    </a>
    <a href="{{ route('user.withdraw.view') }}" class="card rounded-md p-4 px-2 text-center dark:text-white">
        <div class="mx-auto text-2xl">
            <iconify-icon icon="heroicons-outline:upload"></iconify-icon>
        </div>
        <span class="text-sm">{{ __('Withdraw') }}</span>
    </a>
    <a href="{{ route('user.transfer') }}" class="card rounded-md p-4 px-2 text-center dark:text-white">
        <div class="mx-auto text-2xl">
            <iconify-icon icon="akar-icons:arrow-repeat"></iconify-icon>
        </div>
        <span class="text-sm">{{ __('Transfer') }}</span>
    </a>
    <a href="{{ route('user.forex-account-logs') }}" class="card rounded-md p-4 px-2 text-center dark:text-white">
        <div class="mx-auto text-2xl">
            <iconify-icon icon="uil:chart-line"></iconify-icon>
        </div>
        <span class="text-sm">{{ __('Accounts') }}</span>
    </a>
    <a href="{{ route('user.kyc') }}" class="card rounded-md p-4 px-2 text-center dark:text-white">
        <div class="mx-auto text-2xl">
