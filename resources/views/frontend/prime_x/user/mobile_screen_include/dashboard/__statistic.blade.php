                        ...
                        <div class="card-body p-3">
                            <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <div class="flex-1 content">
                                    <div class="text-slate-600 dark:text-slate-300 text-sm mb-1 font-medium">{{ __('All Transactions') }}</div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <div class="flex-1 content">
                                    <div class="text-slate-600 dark:text-slate-300 text-sm mb-1 font-medium">{{ __('Total Deposit') }}</div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <div class="flex-1 content">
                                    <div class="text-slate-600 dark:text-slate-300 text-sm mb-1 font-medium">{{ __('Total Investment') }}</div>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="flex-1 content">
                                        <div class="text-slate-600 dark:text-slate-300 text-sm mb-1 font-medium">{{ __('Total Profit') }}</div>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="flex-1 content">
                                        <div class="text-slate-600 dark:text-slate-300 text-sm mb-1 font-medium">{{ __('Total Transfer') }}</div>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="flex-1 content">
                                        <div class="text-slate-600 dark:text-slate-300 text-sm mb-1 font-medium">{{ __('Total Withdraw') }}</div>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="flex-1 content">
                                        <div class="text-slate-600 dark:text-slate-300 text-sm mb-1 font-medium">{{ __('Referral Bonus') }}</div>
