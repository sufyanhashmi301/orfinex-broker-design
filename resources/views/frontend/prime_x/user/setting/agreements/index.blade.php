                            ...
                            <div class="flex-1 flex items-center space-x-2 rtl:space-x-reverse">
                                <div class="flex-none">
                                    @switch($documentLink->slug)
                                        @case('aml_policy')
                                        <iconify-icon class="text-2xl dark:text-white" icon="solar:shield-minimalistic-linear"></iconify-icon>
                                        @break
                                        @case('client_agreement')
                                        <iconify-icon class="text-2xl dark:text-white" icon="icon-park-outline:agreement"></iconify-icon>
                                        @break
                                        @case('complaints_handling_policy')
                                        <iconify-icon class="text-2xl dark:text-white" icon="bx:support"></iconify-icon>
                                        @break
                                        @case('cookies_policy')
                                        <iconify-icon class="text-2xl dark:text-white" icon="solar:shield-minimalistic-linear"></iconify-icon>
                                        @break
                                        @case('ib_partner_agreement')
                                        <iconify-icon class="text-2xl dark:text-white" icon="mdi:family-tree"></iconify-icon>
                                        @break
                                        @case('order_execution_policy')
                                        <iconify-icon class="text-2xl dark:text-white" icon="fluent:document-copy-20-regular"></iconify-icon>
                                        @break
                                        @case('privacy_policy')
                                        <iconify-icon class="text-2xl dark:text-white" icon="solar:clipboard-linear"></iconify-icon>
                                        @break
                                        @case('risk_disclosure')
                                        <iconify-icon class="text-2xl dark:text-white" icon="tabler:info-hexagon"></iconify-icon>
                                        @break
                                        @case('us_clients_policy')
                                        <iconify-icon class="text-2xl dark:text-white" icon="la:flag-usa"></iconify-icon>
                                        @break
                                        @default()
                                        <iconify-icon class="text-2xl dark:text-white" icon="lucide:file-text"></iconify-icon>
                                    @endswitch
                                </div>
                                <div class="flex-1">
