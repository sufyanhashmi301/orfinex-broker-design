                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="input-area relative">
                        ...
                        <div class="input-group">
                            <select name="gender" id="kycTypeSelect" class="select2 form-control w-full mt-2 py-2" required>
                    ...
                    <div class="input-area relative">
                        ...
                        <input type="text" class="form-control" name="city" value="{{ $user->city }}" placeholder="{{ __('City') }}" />
                    </div>
                    <div class="input-area relative">
                        <label for="exampleFormControlInput1" class="form-label">{{ __('Zip') }}</label>
                        <input type="text" class="form-control" name="zip_code" value="{{ $user->zip_code }}" placeholder="{{ __('Zip') }}" />
                    </div>
                    <div class="input-area relative">
                    ...
                    <div class="input-area relative">
                        ...
                        <input type="text" class="form-control disabled" value="{{ carbonInstance($user->created_at)->toDayDateTimeString() }}" placeholder="{{ __('Joining Date') }}" disabled />
                    </div>
                </div>
