                    ...
                    <div class="h-[260px] bg-no-repeat bg-cover bg-center flex items-center justify-center" style="background-image: url('{{ asset('frontend/images/videos-thumbnail.jpg') }}')">
                        <a href="" class="inline-flex">
                            <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M30.6075 16.8L9.8 29.3475C8.575 30.0825 7 29.2075 7 27.7725V13.7725C7 7.66499 13.5975 3.84999 18.9 6.89499L26.9325 11.515L30.59 13.615C31.7975 14.3325 31.815 16.0825 30.6075 16.8Z" fill="#0ebe3b"/>
                                <path d="M31.6574 27.055L24.5699 31.15L17.4999 35.2275C14.9624 36.68 12.0924 36.3825 10.0099 34.9125C8.99491 34.2125 9.11741 32.655 10.1849 32.025L32.4274 18.69C33.4774 18.06 34.8599 18.655 35.0524 19.8625C35.4899 22.575 34.3699 25.4975 31.6574 27.055Z" fill="#0ebe3b"/>
                            </svg>
                        </a>
                    </div>
