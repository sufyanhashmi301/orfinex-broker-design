            ...
            <div class="card-body p-6 pb-0">
                @if(count($withdraws) == 0)
                    <div class="flex items-center justify-center flex-col">
                        ...
                        <a href="{{ route('user.withdraw.view') }}" class="btn btn-dark inline-flex items-center justify-center min-w-[170px]">
                            {{ __('Withdraw Now') }}
                        </a>
                    </div>
                @else
                    <div class="innerMenu grid xl:grid-cols-2 grid-cols-1 gap-5 mb-6">
                        <div class="filter">
                            ...
                            <form method="POST" action="{{ route('user.withdraw.log.export') }}">
                                @csrf
