<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
     id="confirmAccountCreationCancelModal"
     tabindex="-1"
     aria-labelledby="confirmAccountCreationCancelModal"
     aria-hidden="true"
>
        ...
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-dark bg-clip-padding rounded-md outline-none text-current">
            <div class="modal-body p-6 py-8 text-center space-y-5">
                ...
                <div class="action-btns">
                    <button type="button" class="confirmAccountCreationCancelBtn btn btn-dark inline-flex items-center justify-center mr-2">
