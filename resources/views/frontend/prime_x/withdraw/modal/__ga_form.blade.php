        ...
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white dark:bg-dark bg-clip-padding rounded-md outline-none text-current">
            <div class="modal-body px-6 py-6 text-center">
                ...
                <div class="title mb-2">
                    <h4 class="text-xl font-medium dark:text-white capitalize" id="gaModalLabel">
                ...
                <div class="input-area mt-5">
                    <input type="password" maxlength="6" pattern="[0-9]*" inputmode="numeric" class="form-control !text-lg text-center tracking-widest" id="gaInput" placeholder="{{ __('Enter 6-digit code') }}" />
                </div>
                <div class="text-xs text-slate-500 mt-2">{{ __('Codes refresh every 30 seconds.') }}</div>
                <div class="action-btns mt-5">
                    <button type="button" class="gaSubmitBtn btn btn-dark inline-flex items-center justify-center mr-2">
